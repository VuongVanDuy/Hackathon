...
class BusMapApp(QWidget):
    def __init__(self, parent=None):
        super().__init__(parent)
        
        self.setupUI()
        self.btn1.clicked.connect(lambda: self.showRoute('./1062.html'))
        self.btn2.clicked.connect(lambda: self.showRoute('./1064.html'))
        self.btn3.clicked.connect(lambda: self.showRoute('./1065.html'))
